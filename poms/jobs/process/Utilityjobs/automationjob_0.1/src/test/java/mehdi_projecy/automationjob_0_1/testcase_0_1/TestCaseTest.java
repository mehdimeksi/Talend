...
package mehdi_projecy.automationjob_0_1.testcase_0_1;
...
public class TestCaseTest implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TestCaseTest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_MEHDI_PROJECY_TestCase = new byte[0];
		static byte[] commonByteArray_MEHDI_PROJECY_TestCase = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MEHDI_PROJECY_TestCase.length) {
					if (length < 1024 && commonByteArray_MEHDI_PROJECY_TestCase.length == 0) {
						commonByteArray_MEHDI_PROJECY_TestCase = new byte[1024];
					} else {
						commonByteArray_MEHDI_PROJECY_TestCase = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MEHDI_PROJECY_TestCase, 0, length);
				strReturn = new String(commonByteArray_MEHDI_PROJECY_TestCase, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MEHDI_PROJECY_TestCase) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "testautomation", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
...
// Start of branch "row2"
						if (row2 != null) {
							...
							if (enableLogStash) {
								if (runStat.updateLog(iterateId, 1, 1
										...
										, "row2", "tFileInputDelimited_1", "testautomation", "tFileInputDelimited",
				...
				if (enableLogStash) {
					...
					if (runStat.log(resourceMap, iterateId, "row2", 2, 0, "tFileInputDelimited_1", "testautomation",
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (((Integer) globalMap.get("tFileInputDelimited_1_NB_LINE") == (Integer) globalMap
					...
					tAssertCatcher_1.addMessage(pid, projectName, jobName, "java", "tAssert_1", "Ok", "--",
							"File from reference equal from input");
					tAssertCatcher_1Process(globalMap);
				} else {
					tAssertCatcher_1.addMessage(pid, projectName, jobName, "java", "tAssert_1", "Failed",
							"Test logically failed", "File from reference equal from input");
					tAssertCatcher_1Process(globalMap);
				}
				...
				if (!((Integer) globalMap.get("tFileInputDelimited_1_NB_LINE") == (Integer) globalMap
					...
					junitGlobalMap.put("tests.log", ((String) junitGlobalMap.get("tests.log")) + "tAssert_1:"
							+ "File from reference equal from input" + java.lang.System.getProperty("line.separator"));
	...
	public void testDefault() throws java.lang.Exception {
		...
		java.net.URL url_reference_file1 = getClass().getResource(
				"/mehdi_projecy/automationjob_0_1/testcase_0_1/datas/TestCase_Default_reference_file1_out.csv");
		instance_reference_file1 = "reference_file1="
				+ java.net.URLDecoder.decode(url_reference_file1.getPath(), "UTF-8");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TestCaseTest.class.getClassLoader().getResourceAsStream(
					"mehdi_projecy/automationjob_0_1/testcase_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = TestCaseTest.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TestCaseTest");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 93285 characters generated by Talend Data Management Platform on the 14
 * September 2022 15:32:52 BST
 ************************************************************************************************/